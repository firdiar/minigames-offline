using System;
using UnityEngine;
using AllIn1SpringsToolkit.Scripts.Utils;
...
namespace AllIn1SpringsToolkit.Demo.Scripts
{
    public class Arrow : MonoBehaviour
    {
        ...
        public void ReadyArrow(ArrowsDemoController newArrowsDemoController, Vector3 newPos, Transform newParent)
        {
            gameObject.SetActive(true);
            colliderStopperGameObject.SetActive(true);
            hasCollided = false;
            hasBeenShot = false;
            arrowsDemoController = newArrowsDemoController;
            timeSinceReady = 0f;
