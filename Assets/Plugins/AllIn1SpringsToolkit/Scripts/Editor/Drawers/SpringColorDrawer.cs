...
namespace AllIn1SpringsToolkit
{
	public class SpringColorDrawer : SpringDrawer
	{
		...
		{
			springColorEditorObject.CurrentValue = DrawColorField(currentRect, label, LabelWidth, springColorEditorObject.CurrentValue);
		}
		...
		{
			springColorEditorObject.OperationValue = DrawCustomVector3(currentRect, FIELD_NAME_OPERATION_VALUE, COMPONENTS_LABELS_RGBA, springColorEditorObject.OperationValue);
		}
