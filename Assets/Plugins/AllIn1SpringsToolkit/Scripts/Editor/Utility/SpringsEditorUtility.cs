...
namespace AllIn1SpringsToolkit
{
	public static class SpringsEditorUtility
	{
		...
		{
			Vector4Bool res = (Vector4Bool)DrawVectorBool(position, label, string.Empty, componentsLabel, labelWidth, vector4Bool);
			return res;
		}
		...
		{
			Vector4Bool res = (Vector4Bool)DrawVectorBool(position, label, tooltip, componentsLabel, labelWidth, vector4Bool);
			return res;
		}

		public static IVectorBool DrawVectorBool(Rect position, string label, string tooltip, string[] componentsLabels, float labelWidth, IVectorBool vectorBool)
		{
		...
		{
			Vector2Bool res = (Vector2Bool)DrawVectorBool(position, label, string.Empty, componentsLabels, labelWidth, vector2Bool);
			return res;
		}
		...
		{
			Vector2Bool res = (Vector2Bool)DrawVectorBool(position, label, tooltip, componentsLabels, labelWidth, vector2Bool);
			return res;
		}
		...
		{
			Vector3Bool res = (Vector3Bool)DrawVectorBool(position, label, string.Empty, componentsLabels, labelWidth, vector3Bool);
			return res;
		}
		...
		{
			Vector3Bool res = (Vector3Bool)DrawVectorBool(position, label, tooltip, componentsLabels, labelWidth, vector3Bool);
			return res;
		}
