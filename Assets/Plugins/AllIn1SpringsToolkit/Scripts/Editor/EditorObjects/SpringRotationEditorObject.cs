...
namespace AllIn1SpringsToolkit
{
	public class SpringRotationEditorObject : SpringEditorObject
	{
		...
		public Vector3 MinValue
		{
			...
			{
				Vector3 res = new Vector3(
					springValuesEditorObjects[GLOBAL_AXIS_X].GetMinValue(),
					springValuesEditorObjects[GLOBAL_AXIS_Y].GetMinValue(),
					springValuesEditorObjects[GLOBAL_AXIS_Z].GetMinValue());

				return res;
			}
			set
			{
				springValuesEditorObjects[GLOBAL_AXIS_X].SetMinValue(value.x);
				springValuesEditorObjects[GLOBAL_AXIS_Y].SetMinValue(value.y);
				springValuesEditorObjects[GLOBAL_AXIS_Z].SetMinValue(value.z);
			}
		}
		...
		public Vector3 MaxValue
		{
			...
			{
				Vector3 res = new Vector3(
					springValuesEditorObjects[GLOBAL_AXIS_X].GetMaxValue(),
					springValuesEditorObjects[GLOBAL_AXIS_Y].GetMaxValue(),
					springValuesEditorObjects[GLOBAL_AXIS_Z].GetMaxValue());

				return res;
			}
			set
			{
				springValuesEditorObjects[GLOBAL_AXIS_X].SetMaxValue(value.x);
				springValuesEditorObjects[GLOBAL_AXIS_Y].SetMaxValue(value.y);
				springValuesEditorObjects[GLOBAL_AXIS_Z].SetMaxValue(value.z);
			}
		}
